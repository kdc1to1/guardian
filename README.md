...
js/firebase-config.js → Firebase প্রজেক্ট কনফিগ (নিজের কী দিয়ে পূরণ করুন)
js/app.js            → গার্ডিয়ান অ্যাপের লজিক
js/admin.js          → এডমিন প্যানেলের লজিক
...
4. **Project settings > General > Your apps** থেকে একটি Web app যুক্ত করুন, এবং যে কনফিগ অবজেক্ট পাবেন তা `js/firebase-config.js`-এ বসান।
...
- PWA আইকন (`icons/icon-192.png`, `icons/icon-512.png`) — প্লেসহোল্ডার লোগো, নিজের ডিজাইন দিয়ে বদলে নিতে পারেন
